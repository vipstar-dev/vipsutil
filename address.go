...
// and netID which encodes the vipstarcoin network and address type.  It is used
...
//
// The vipstarcoin network the address is associated with is extracted if possible.
...
// with the passed vipstarcoin network.
