...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/vipstar-dev/vipsutil/txsort)
...
```bash
$ go get -u github.com/vipstar-dev/vipsutil/txsort
```
