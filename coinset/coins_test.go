...
func NewCoin(index int64, value vipsutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = vipsutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = vipsutil.NewTxFromBytes(testSimpleCoinTxBytes)
